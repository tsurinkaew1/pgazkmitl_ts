function pgaz_pf_nr()
    ...
    fprintf('\nP G A z v 1.0.0 a\n\n');   
    fprintf('Power Flow Solution by Gauss Seidel Method\n\n');
    fprintf('File:  %s\n',LocationImportData);
    ...
    outputStringStats = sprintf('Power Flow Solution by Gauss Seidel Method\n\n');
    ...
    report = [report, sprintf('   Power Flow Solution by Gauss Seidel Method\n')];
